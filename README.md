<div align="center">
  <br />
    <a href="https://youtu.be/QRrPE9aj3wI?feature=shared" target="_blank">
      <img src="https://i.postimg.cc/dt6DpCXM/preview.png" alt="Project Banner">
    </a>
  <br />
  <br />
  <br />
  ...
  <h3 align="center">Cactus  Landing Page</h3>
</div>
...
Develop a Cactus website showcasing cactus, plan using HTML and CSS with smooth subtle animations. 
...
```bash
git https://github.com/Mohamadreza-Hosseinkhani/cactus-web.git
cd cactus-web
```
